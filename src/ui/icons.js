...
export const ICONS = {
  ...
  pirateSkull: [
    'M12 2a6.5 6.5 0 0 1 6.5 6.5c0 2.6-1.6 3.9-2.7 5H8.2C7.1 12.4 5.5 11.1 5.5 8.5A6.5 6.5 0 0 1 12 2z',
    'M9.5 8.5h.01', 'M14.5 8.5h.01',
    'M10.2 13.5v2', 'M13.8 13.5v2',
    'M4 17l16 4.5', 'M20 17 4 21.5',
  ], // 해적 해골 (졸리 로저) — 리셋 3단계(최후통첩)에서만 사용
  resetArrow: [
