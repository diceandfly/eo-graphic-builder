...
export const THREAD_MIN_RATIO = 2 / 960; // col 폭 < W·비율 이면 thread를 W·비율 폭 직사각형으로 렌더
// §89: UI는 px 입력(선택 유닛 W 기준 환산), 내부는 비율 유지(닮은꼴 보존). 기본 = 기본 유닛 960px에서 2px 상당
...
// 스와치 구성 (표시 순서). 6번은 §82 BLACK(#000000) → §85 SPACE BLACK으로 교체.
const SWATCHES = [
  ['EO NEON', 'eo-neon'],
