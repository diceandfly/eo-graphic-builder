...
// §172·§181·§195: 마우스 글리프 크롭 — 스트로크 바깥 절반(±1u)까지 포함해 잘림 없이,
// 상하좌 0.5u·우 1.5u(내부 여백) 패딩. (일반 아이콘은 24 정사각 뷰박스 그대로)
const ICON_CROP = { mouseL: [3.5, 0.5, 18, 23], mouseR: [3.5, 0.5, 18, 23] };
